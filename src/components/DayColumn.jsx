...
import { Plus, Trash2, Check, Copy, Pin, AlertTriangle } from 'lucide-react';
...
export default function DayColumn({
    ...
    useEffect(() => {
        ...
        if (showCopyMenu || showClearMenu) {
            document.addEventListener('mousedown', handleClickOutside);
        }
        return () => document.removeEventListener('mousedown', handleClickOutside);
    }, [showCopyMenu, showClearMenu]);
                ...
                <div className="flex items-center gap-0.5 sm:gap-1 print:hidden relative">
                    ...
                    {totalBlocks > 0 && (
                        <div className="relative" ref={clearMenuRef}>
                            ...
                            {showClearMenu && (
                                <div className="absolute right-0 top-10 z-50 w-44 p-3 bg-zinc-900 border border-zinc-800 rounded-xl shadow-xl space-y-2.5">
                                    ...
                                    <div className="flex gap-1.5">
                                        <button
                                            ...
                                            className="flex-1 py-1 text-xs font-medium text-zinc-400 hover:text-zinc-200 bg-zinc-950 hover:bg-zinc-900 rounded-lg transition-colors cursor-pointer border border-zinc-800"
                                        >
                                            Não
                                        </button>
                                        <button
                                            ...
                                            className="flex-1 py-1 bg-red-700 hover:bg-red-800 text-white text-xs font-medium rounded-lg transition-colors cursor-pointer"
                                        >
                                            Sim
                                        </button>
                                    </div>
